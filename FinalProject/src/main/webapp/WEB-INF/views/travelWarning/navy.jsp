...
<link rel="stylesheet" href="${path }/resources/css/TravelWarning/navy.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<script src="${path }/resources/js/TravelWarning/navy.js"></script>
</head>
<body>
<section>
<div class="section_wrap">
	...
	<table>
		<tr>
			<td>중동/아프리카</td>
			<td>
				<c:forEach var="item" items="${navy }">
					<c:if test="${item.continent eq '중동/아프리카' }">
						<c:out value="${item.countryName }" /> (<c:out value="${item.attentionNote }" />)<br/>
					</c:if>
			 	</c:forEach>
			</td>
		</tr>
