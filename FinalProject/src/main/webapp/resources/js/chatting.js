$(document).ready(function () {
	...
	let southAmerica_color = document.querySelector('.southAmerica_color');
	  $("#chatting").on("click", ".eu_black", function () {
			alert("유럽방에 입장했습니다");
			window.open("http://192.168.0.84:8090/FinalProject/chat-ws.jsp", "eu", "width=450, height=700, left=100, top=50");
	  ...
	  $("#chatting").on("click", ".asia_black", function () {
		    alert("아시아방에 입장했습니다");
			window.open("http://192.168.0.84:8090/FinalProject/chat-ws.jsp", "asia", "width=450, height=700, left=100, top=50");
	  ...
	  $("#chatting").on("click", ".northAmerica_black", function () {
			...
			window.open("http://192.168.0.84:8090/FinalProject/chat-ws.jsp", "northAmerica", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
	  ...
	  $("#chatting").on("click", ".africa_black", function () {
		  	alert("아프리카방에 입장했습니다");
			window.open("http://192.168.0.84:8090/FinalProject/chat-ws.jsp", "africa", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
			northAmerica_black.style.display ='block';
	  ...
	  $("#chatting").on("click", ".oceania_black", function () {
			...
			window.open("http://192.168.0.84:8090/FinalProject/chat-ws.jsp", "oceania", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
			northAmerica_black.style.display ='block';
			africa_black.style.display ='block';
	  ...
	  $("#chatting").on("click", ".southAmerica_black", function () {
			...
			window.open("http://192.168.0.84:8090/FinalProject/chat-ws.jsp", "southAmerica", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
			northAmerica_black.style.display ='block';
			africa_black.style.display ='block';
