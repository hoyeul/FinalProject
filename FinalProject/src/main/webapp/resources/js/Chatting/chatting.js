$(document).ready(function () {
	...
	let southAmerica_color = document.querySelector('.southAmerica_color');
	  $("#chatting").on("click", ".eu_black", function () {
			alert("유럽방에 입장했습니다");
			window.open("http://192.168.0.95:8090/chat-ws-Eu.jsp", "eu", "width=450, height=700, left=100, top=50");
	  ...
	  $("#chatting").on("click", ".asia_black", function () {
		    alert("아시아방에 입장했습니다");
			window.open("http://192.168.0.95:8090/chat-ws-Asia.jsp", "asia", "width=450, height=700, left=100, top=50");
	  ...
	  $("#chatting").on("click", ".northAmerica_black", function () {
			...
			window.open("http://192.168.0.95:8090/chat-ws-NorthAmerica.jsp", "northAmerica", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
	  ...
	  $("#chatting").on("click", ".africa_black", function () {
		  	alert("아프리카방에 입장했습니다");
			window.open("http://192.168.0.95:8090/chat-ws-Africa.jsp", "africa", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
			northAmerica_black.style.display ='block';
	  ...
	  $("#chatting").on("click", ".oceania_black", function () {
			...
			window.open("http://192.168.0.95:8090/chat-ws-Oceania.jsp", "oceania", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
			northAmerica_black.style.display ='block';
			africa_black.style.display ='block';
	  ...
	  $("#chatting").on("click", ".southAmerica_black", function () {
			...
			window.open("http://192.168.0.95:8090/chat-ws-SouthAmerica.jsp", "southAmerica", "width=450, height=700, left=100, top=50");
			eu_black.style.display ='block';
			asia_black.style.display ='block';
			northAmerica_black.style.display ='block';
			africa_black.style.display ='block';
